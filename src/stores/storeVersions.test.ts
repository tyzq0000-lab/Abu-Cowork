...
const PERSISTED_STORES = [
  { key: 'abu-settings', minVersion: 33 },
  ...
  { key: 'abu-schedule', minVersion: 4 },
  { key: 'abu-triggers', minVersion: 5 },
  ...
  { key: 'abu-employee-deployments', minVersion: 4 },
  { key: 'abu-employee-ledger', minVersion: 1 },
  { key: 'abu-sop', minVersion: 1 },
] as const;
...
beforeAll(async () => {
  ...
  await import('./ledgerStore');
  await import('./sopStore');
});
