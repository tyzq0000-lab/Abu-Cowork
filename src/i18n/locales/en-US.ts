...
const enUS: TranslationDict = {
  ...
  settings: {
    ...
    // Sandbox
    sandbox: 'Security',
    sandboxDescription: 'Use macOS Seatbelt sandbox to restrict shell command file system access, preventing malicious commands from reading sensitive files or writing outside the working directory.',
    ...
    sandboxMacOSOnly: 'OS-level sandbox is not available on this platform (macOS only).',
  ...
  project: {
    ...
    migrationBanner: 'Found {count} groups of conversations that can be organized into projects',
    migrationAction: 'Organize All',
    migrationDismiss: 'Later',
