...
const enUS: TranslationDict = {
  ...
  memory: {
    ...
    privateDesc: 'When enabled, this memory is not auto-injected into the conversation. Fuyao only reads it when you explicitly ask, and the reply will only quote what is necessary.',
    privateDescHintTitle: 'Current description may leak content',
    privateDescHintBody: 'A private memory\'s "description" still appears in the MEMORY.md index injected into every turn. Rewrite it as a topic, not the value. Fuyao has suggested one based on the memory\'s name — just click save, or edit if you prefer.',
    ...
    auditIntro: '{count} memories appear to contain sensitive information. We recommend marking them as private. Private memories are never auto-injected, but Fuyao can still read them when you explicitly ask.',
  ...
  soul: {
    title: 'Fuyao\'s Personality',
    subtitle: 'Fuyao comes with a default personality — customize it to your liking',
    placeholder: 'Describe Fuyao\'s personality in markdown...',
    saving: 'Saving...',
    saved: 'Saved',
    ...
    proactivityDesc: 'How actively Fuyao proposes to save workflows as skills. Shy = only when you ask. Companion = propose when clearly helpful (recommended). Butler = consider every successful task.',
  },
  ...
  sidebar: {
    ...
    personalMemoryDesc: 'Preferences and habits Fuyao remembers about you, applied across all projects.',
    personalMemoryPlaceholder: 'Fuyao automatically remembers your preferences like communication style, tools you use, etc...',
    personalMemoryClearMessage: 'Are you sure you want to clear all personal memory? This cannot be undone.',
    memoryGuideTitle: 'Fuyao\'s Three Layers of Memory',
    memoryGuidePersonalName: 'Personal Memory (this page)',
    memoryGuidePersonalDesc: 'Preferences Fuyao remembers about you — like your name, communication style, etc. Applies across all projects. You can also edit it manually.',
  ...
  account: {
    ...
    personalRole: 'Personal account',
    enterpriseRole: 'Enterprise account',
    adminRole: 'Administrator',
    deviceSessions: 'Signed-in devices',
    deviceSessionsDescription: 'A revoked device must sign in again before it can use this account.',
  ...
  chat: {
    inputPlaceholder: 'What can Fuyao help you with?',
    inputPlaceholderBusy: 'Fuyao is working...',
    inputPlaceholderWithSkill: 'Enter parameters...',
    inputPlaceholderWithAgent: 'Enter task description...',
    inputPlaceholderMidTask: 'Add instructions (Fuyao reads next turn)...',
    start: 'Start',
    stop: 'Stop',
    welcomeTitle: 'Leave it to Fuyao ✨',
    welcomeSubtitle: "Hey~ I'm Fuyao, your desktop buddy! From now on, leave everything to me~",
    disclaimer: 'Fuyao may make mistakes. Please verify important information.',
    thinking: 'Thinking…',
    ...
    setupRequiredDesc: 'Fuyao needs an API Key to get started. Head to settings to configure it!',
  ...
  settings: {
    ...
    webSearchDescription: 'Configure web search services so Fuyao can search the web for latest information',
    ...
    behaviorSensorDesc: 'Record active window titles to help Fuyao understand your work patterns (window titles only, no screen content)',
    ...
    behaviorSensorPermissionGuide: 'Go to System Settings → Privacy & Security → Automation, and allow Fuyao to control "System Events"',
    computerUse: 'Computer Use',
    computerUseDesc: 'Enable screenshot capture and keyboard/mouse simulation. Fuyao can see your screen and operate your computer.',
    computerUsePermissionDenied: 'Cannot capture screen. Please grant Screen Recording permission.',
    computerUsePermissionGuide: 'Go to System Settings → Privacy & Security → Screen Recording, and allow Fuyao. You may also need to grant Accessibility permission for keyboard/mouse control.',
    preventSleep: 'Prevent system sleep',
    preventSleepDesc: 'Keep the system awake while Fuyao is running. When on AC power, closing the lid will not interrupt tasks. (Windows: idle sleep only)',
    // Permission mode
  ...
  sandbox: {
    ...
    retryHint: 'Please ask Fuyao to retry the operation',
    goToSettings: 'Go to settings',
    authorizedPaths: 'Authorized write directories',
    authorizedPathsEmpty: 'No authorized directories yet. Fuyao will request authorization when needed.',
    revoke: 'Revoke',
  },

  diagnostic: {
    title: 'Diagnostic',
    desc: 'Check Fuyao\'s health. Export a diagnostic bundle when reporting issues.',
    ...
    categoryEmployees: 'Digital Employees',
    ...
    actionOpenEmployee: 'Open employee',
    copiedError: 'Error copied',
    aiServicesNoProvider: 'No AI service configured',
    aiServicesNoProviderHint: 'Enable at least one provider to chat with Fuyao',
    ...
    employeeNone: 'No digital employees installed',
    employeeNoneHint: 'Employment checks appear here after installation',
    employeePackage: 'Employee package',
    employeePackageReady: 'Installation intact',
    employeePackageSigned: 'Platform signature verified',
    employeePackageMissing: 'A deployment record exists, but the employee package is not installed or loaded',
    employeeSignatureMissing: 'The platform employee has no install signature baseline; redeploy it from uprow',
    employeeRuntimeInvalid: 'The employee runtime contract is missing or invalid',
    employeeWorkspace: 'Workspace access',
    employeeWorkspaceOptional: 'No workspace bound',
    employeeWorkspaceMissing: 'This employee requires a project workspace',
    employeeWorkspaceDenied: 'The employee workspace is not writable',
    employeeDependencies: 'Runtime dependencies',
    employeeDependenciesNone: 'No additional dependencies',
    employeeDependenciesSummary: '{ready}/{total} ready',
    employeeDependenciesNeedAttention: 'Some dependencies are not ready',
    employeeDependencyReady: 'Ready',
    employeeDependencyNeedsAuthorization: 'Authorization required',
    employeeDependencyNeedsConfiguration: 'Configuration required',
    employeeDependencyUnavailable: 'Unavailable',
    employeeModel: 'Model channel',
    employeeModelUsesGlobal: 'Covered by the AI service checks above',
    employeeModelBindingMissing: 'The employee model binding is incomplete',
    employeeModelUnavailable: 'The employee model channel is unavailable; check it and redeploy',
    ...
    errMap: {
      ...
      aiContextTooLong: 'Probe request was too large (this is an Fuyao bug, please report)',
      ...
      permTauriScope: 'Fuyao\'s internal permission scope is missing this path (this is a bug, please report)',
  ...
  toolbox: {
    ...
    createWithAbu: 'Create with Fuyao',
    ...
    categoryAgentEvolved: 'Fuyao evolved',
    categoryAgentEvolvedEmpty: "Fuyao will propose reusable skills from your recurring tasks, and they'll land here for you to accept, reject, or decide later.",
    ...
    // Drafts onboarding
    draftsOnboardTitle: 'Let Fuyao grow with you',
    draftsOnboardBody: 'Fuyao can save how-to recipes as drafts for your review. Pick how proactive:',
    ...
    skillProposalCardTitle: '💡 Fuyao proposes saving a skill',
    ...
    skillProposalCardOnboardGate: "Fuyao proposed your first skill. Open the Toolbox to pick a proactivity level, then come back to decide.",
    skillProposalCardOnboardGateAction: 'Open Toolbox to finish setup',
    skillPatchedCardLabel: 'Fuyao patched skill',
    skillPatchGroupLabel: 'Fuyao modified skill',
    skillDeletedCardLabel: 'Fuyao deleted skill',
    ...
    historyEmpty: "No modifications recorded yet. Any change Fuyao makes to this skill will show up here.",
    ...
    categoryBlocksHint: 'Skills you marked "don\'t propose this kind". Unblock to let Fuyao suggest them again.',
  },

  permission: {
    workspace: {
      title: 'Workspace Access',
      description: 'Fuyao needs access to this folder to help you',
      capabilities: [
        'Read files in the folder',
        'Create and modify files',
        'List directory structure',
      ],
      warning: 'Fuyao can read and write all files in this directory. Please ensure you trust this action.',
    },
    shell: {
      title: 'Shell Command Permission',
      description: 'Fuyao needs to execute system commands',
      capabilities: [
    ...
    fileWrite: {
      ...
      description: 'Fuyao needs to create or modify files',
      capabilities: [
        'Create new files',
        'Modify existing file content',
        'Create necessary directories',
      ],
      warning: 'This action will modify your files. Fuyao will be careful, but please verify the path is correct.',
    },
    fileRead: {
      title: 'File Read Permission',
      description: 'Fuyao needs to read files in this directory',
      capabilities: [
        'Read file contents in the folder',
        'List directory structure',
        'Search file contents',
      ],
      warning: 'Fuyao can read all file contents under this directory.',
    },
    folderSelect: {
      title: 'Select Working Folder',
      description: 'Fuyao needs to know which folder to work in',
      selectButton: 'Select Folder',
      hint: 'Only accesses the folder you select',
      authorizeTitle: 'Workspace Access',
      authorizeDescription: 'Fuyao needs access to this folder to help you with the task',
      ...
      authorizeWarning: 'Fuyao can read and write all files under this directory. Make sure you trust this operation.',
    },
    abuCanDo: 'Fuyao will be able to:',
    allowOnce: 'Allow Once',
    allowAlways: 'Always Allow',
    deny: 'Deny',
    rememberChoice: 'Always allow access to this folder',
    rememberChoiceDescription: 'Fuyao will remember this and not ask again',
  ...
  panel: {
    ...
    instructionsDesc: 'Tell Fuyao how to work in this project. Loaded automatically in every conversation.',
    ...
    memoryDesc: 'Knowledge Fuyao has automatically accumulated from conversations.',
    memoryPlaceholder: 'Fuyao will automatically remember project knowledge from conversations...',
    memoryClear: 'Clear',
  ...
  schedule: {
    ...
    taskPromptPlaceholder: 'Enter the instructions for Fuyao...',
    frequency: 'Frequency',
    ...
    noTasksHint: 'Create a scheduled task to let Fuyao automate repetitive work',
    ...
    askAbuToCreate: 'Ask Fuyao to create',
  ...
  trigger: {
    ...
    infoBanner: 'Triggers receive external events via HTTP and automatically run Fuyao tasks',
    triggerName: 'Trigger Name',
    triggerNamePlaceholder: 'e.g., Group Alert Handler',
    description: 'Description',
    descriptionPlaceholder: 'Describe the purpose of this trigger...',
    triggerPrompt: 'Prompt',
    triggerPromptPlaceholder: 'Instructions for Fuyao when event is received...',
    ...
    noTriggersHint: 'Create a trigger to let Fuyao respond to external events automatically',
    ...
    imScopeMentionOnly: '@Fuyao mentions only',
  ...
  imChannel: {
    title: 'IM Channels',
    description: 'Connect IM platforms so users can @Fuyao or DM the bot directly',
    ...
    noChannelsHint: 'Add an IM channel to let users interact with Fuyao via instant messaging',
    ...
    wechatBindHint: 'Scan the QR code with WeChat to let Fuyao receive and reply to messages (private chat only)',
  ...
  guide: {
    ...
    step2Desc: 'Click "New Task" to start chatting with Fuyao',
  ...
  employeeGrowth: {
    importKnowledge: 'Import employee knowledge',
    runDream: 'Run employee reflection',
    dreamCompletedTitle: 'Employee reflection complete',
    dreamCompleted: '{written} memories saved and {proposed} sent to Review Queue.',
    dreamNoHistoryTitle: 'No history to review',
    dreamNoHistory: 'Complete a substantive work conversation before running reflection.',
    dreamUnavailableTitle: 'Employee reflection unavailable',
    dreamUnavailable: 'This employee package has not enabled Dream or persistent memory.',
    knowledgeCompletedTitle: 'Knowledge import complete',
    knowledgeCompleted: '{imported} imported and {duplicates} duplicates skipped.',
    knowledgeFailedTitle: 'Knowledge import failed',
  },
  ...
  reviewQueue: {
    ...
    accept: 'Approve',
    reject: 'Reject',
    unknownEmployee: 'Fuyao Assistant',
    storageError: 'The approval ledger is unavailable. All external actions are stopped.',
    empty: {
      draft: 'No pending actions',
      accepted: 'No approved actions',
      rejected: 'No rejected actions',
    },
    kind: {
      publish: 'Publish',
      send: 'Send',
    ...
    reason: {
      ...
      interrupted: 'App interrupted; action not executed',
    },
  },
  ...
  commandConfirm: {
    ...
    externalActionTitle: 'Confirm External Action',
    externalActionDescription: 'This action changes an external system and requires your approval:',
    externalActionReason: 'Publishing, sending, payments, and commit actions that cannot be proven read-only require approval every time.',
    externalApprovalUnavailable: 'This external action requires human approval, but the current execution channel cannot request it',
    cancel: 'Cancel',
    confirm: 'Confirm',
  ...
  toolErrors: {
    ...
    disabledByEmployeePolicy: 'Employee tool policy disabled {tool}',
  },
