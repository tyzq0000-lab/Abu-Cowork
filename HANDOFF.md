...
> ⚠️ **2026-08-01：本文件内容截至 2026-06-13（0.23.x 时代），已被 v1.x 发布线取代，仅作历史参考。**
> 2026-07-23 发生过一次不可逆版本线跃迁：`v0.24.0`–`v0.33.0` 标签已被上游 abu-cowork 占用，扶摇改走独立 1.x 线（0.24.0 → 1.0.0，见 `CHANGELOG.md`）。**当前版本 1.0.3。**
> 接手请读 `CHANGELOG.md` + 根 `D:\个人资料\TW\全局待办.md`，不要照本文件第 2/8 节的版本号操作。
